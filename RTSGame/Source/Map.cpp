...
Map::Map(): p(10,10,10,10,50),choza(100), mIsMovingUp(false), mIsMovingDown(false), mIsMovingRight(false), mIsMovingLeft(false) {
    mTexture.loadFromFile("../Media/Desert.png");
    controlador.incluir(new Prota(cachimbo_vida,cachimbo_atk,cachimbo_def,cachimbo_rango,cachimbo_velocidad));
